...
class NoticeRegistrarScreen extends StatefulWidget {
  @override
  _NoticeRegistrarState createState() => _NoticeRegistrarState();
}

class _NoticeRegistrarState extends State<NoticeRegistrarScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeRegistrar();
  }
