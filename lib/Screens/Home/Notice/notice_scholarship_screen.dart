...
class NoticeScholarshipScreen extends StatefulWidget {
  @override
  _NoticeScholarshipState createState() => _NoticeScholarshipState();
}

class _NoticeScholarshipState extends State<NoticeScholarshipScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeScholarship();
  }
