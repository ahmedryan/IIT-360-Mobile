...
class NoticeProjectScreen extends StatefulWidget {
  @override
  _NoticeProjectState createState() => _NoticeProjectState();
}

class _NoticeProjectState extends State<NoticeProjectScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeProject();
  }
