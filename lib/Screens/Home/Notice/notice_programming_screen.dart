...
class NoticeProgrammingScreen extends StatefulWidget {
  @override
  _NoticeProgrammingState createState() => _NoticeProgrammingState();
}

class _NoticeProgrammingState extends State<NoticeProgrammingScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeProgramming();
  }
