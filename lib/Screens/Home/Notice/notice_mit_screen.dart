...
class NoticeMitScreen extends StatefulWidget {
  @override
  _NoticeMitState createState() => _NoticeMitState();
}

class _NoticeMitState extends State<NoticeMitScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeMIT();
  }
