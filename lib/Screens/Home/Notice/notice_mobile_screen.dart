...
class NoticeMobileScreen extends StatefulWidget {
  @override
  _NoticeMobileState createState() => _NoticeMobileState();
}

class _NoticeMobileState extends State<NoticeMobileScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeMobile();
  }
