...
class NoticeMsseScreen extends StatefulWidget {
  @override
  _NoticeMSSEState createState() => _NoticeMSSEState();
}

class _NoticeMSSEState extends State<NoticeMsseScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeMSSE();
  }
