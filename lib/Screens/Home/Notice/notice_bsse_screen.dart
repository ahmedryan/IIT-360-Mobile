...
class NoticeBsseScreen extends StatefulWidget {
  @override
  _NoticeBsseState createState() => _NoticeBsseState();
}

class _NoticeBsseState extends State<NoticeBsseScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeBSSE();
  }
