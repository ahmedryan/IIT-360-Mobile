...
class NoticeDesignScreen extends StatefulWidget {
  @override
  _NoticeDesignState createState() => _NoticeDesignState();
}

class _NoticeDesignState extends State<NoticeDesignScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeDesign();
  }
