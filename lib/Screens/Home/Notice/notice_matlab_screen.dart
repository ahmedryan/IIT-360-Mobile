...
class NoticeMatlabScreen extends StatefulWidget {
  @override
  _NoticeMatlabState createState() => _NoticeMatlabState();
}

class _NoticeMatlabState extends State<NoticeMatlabScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticeMatlab();
  }
