...
class NoticePgditScreen extends StatefulWidget {
  @override
  _NoticePgditState createState() => _NoticePgditState();
}

class _NoticePgditState extends State<NoticePgditScreen> {
  Future<List<Notice>> futureNotice;

  @override
  void initState() {
    super.initState();
    futureNotice = fetchNoticePGDIT();
  }
